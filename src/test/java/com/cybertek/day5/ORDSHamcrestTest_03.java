...
public class ORDSHamcrestTest_03 extends HRTestBase
{
    @DisplayName("GET request to Employees IT_PROG endpoint chaining")
    @Test
    public void employeesTest(){
        ...
        given().accept(ContentType.JSON)
                ...
                .then()
                .statusCode(200)
                // WITHOUT loop it will check every items, it is very important methods
                .body("items.job_id",everyItem(equalTo("IT_PROG")))
                // containsInRelativeOrder, containsInAnyOrder they only care order and existing those values
                ...
                // comparing to list to list so at the beginning we create empty list for comparing
    ...
    public void employeesTest2(){
        ...
        JsonPath jsonPath = given().accept(ContentType.JSON)
                ...
                .body("items.job_id", everyItem(equalTo("IT_PROG")))
                .extract().jsonPath();
        // extract whatever you want for ex: after using jsonpath, we can verification
