...
@JsonProperty("region_id")
  ...
  if they are not matching option is @JsonProperty and then it will create map between religion_id to regionId
  and then deserialize.

lets say you have region_id in the json response but you want to change your variable name to rId,
How can you tell jackson to get region_id value and put inside the rId variable?

so we use @JsonProperty annotation that come from jackson, we provide the jsonkey that we want to map,
 and we put on the top
 */